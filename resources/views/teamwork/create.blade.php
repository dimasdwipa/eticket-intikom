        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('teams.store')}}" autocomplete="off">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-sm input-group input-group-static mb-4 form-group{{ $errors->has('code') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="code" id="input-code" class="form-control form-control-alternative{{ $errors->has('code') ? ' is-invalid' : '' }}" placeholder="GA" value="{{ old('code') }}" required autofocus>
                                ...
                                <div class="col-sm input-group input-group-static mb-4 form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="General Affair" value="{{ old('name') }}" required autofocus>
