@extends('layouts.app', ['page' => 'Asset Loan Approval', 'pageSlug' => 'Asset Loan Approval', 'section' => 'Asset Loan Approval'])
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-2 pb-1">
                            <h6 class="text-white text-capitalize ps-3">Asset Loan Approval</h6>
                        </div>
                    </div>
                            ...
                            <table
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xs font-weight-bolder ps-3">Asset Condition
                                        ...
                                        {{-- <th class="text-uppercase text-secondary text-xs font-weight-bolder ps-3">Tenant</th> --}}
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 ">
                                                                <select class="form-control asset" name="asset" required>
                                                                    ...
                                                                    @foreach ($assets as $asset)
                                                                        <option class="assets" value="{{ $asset->id }}"
                                                                            @if ($asset->id == $item->asset_id) selected @endif>
                                                                            {{ $asset->tag_asset }} -
                                                                            {{ $asset->nama_item }} -
                                                                            {{ $asset->deskripsi }} - {{ $asset->merek }} -
                                                                            {{ $asset->model_type }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="col-12 pr-0 pt-1">
                                                                <input class="form-control form-control-sm border"
                                                                    type="text" name="condition_asset"
                                                                    placeholder="Asset Condition" value="{{$item->asset->condition_asset}}">
                                                            </div>
                                                            <div class="col pr-0 pt-1">
                                                                <input class="form-control form-control-sm border"
                                                                    type="text" name="note"
                                                                    placeholder="Note Aproved">
                                                            </div>
                                                            <div class="col p-0 pt-1">
                                                                <button type="submit"
                                                                    class="btn btn-sm btn-success m-0 p-1 "
                                                                    style="width: 90%">Aproved</button>
                                                            </div>
                                                        </div>

                                                    </form>
                                                    <form action="{{ route('asset-agent.store') }}" method="post"
                                                        class="border border-2 rounded-2 p-1">
                                                        @csrf
                                                        <input type="hidden" name="id" class="dataID"
                                                            value="{{ $item->id }}">
                                                        <input type="hidden" name="resolution" class="dataID"
                                                        ...
                                                        <div class="row">
                                                            <div class="col pr-0">
                                                                <input class="form-control form-control-sm border"
                                                                    type="text" name="note"
                                                                    placeholder="Note Rejected">
                                                            </div>
                                                            <div class="col p-0">
                                                                <button type="submit" class="btn btn-sm btn-danger m-0 p-1"
                                                                    style="width: 90%">Rejected</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                @elseif($item->transaction_type == 'Has been given')
                                                    <form action="{{ route('asset-agent.store') }}" method="post"
                                                        class="border border-2 rounded-2 p-1">
                                                        @csrf
                                                        <input type="hidden" name="id" class="dataID"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 pr-0 pt-1 pb-1">
                                                                <input class="form-control form-control-sm border"
                                                                    type="text" name="condition_asset"
                                                                    placeholder="Asset Condition" value="{{$item->asset->condition_asset}}">
                                                            </div>
                                                            <div class="col pr-0">
                                                                <input class="form-control form-control-sm border"
                                                                    type="text" name="note"
                                                                    placeholder="Note Asset Return">
                                                            </div>
                                                            <div class="col p-0">
                                                                <button type="submit"
                                                                    class="btn btn-sm btn-warning m-0 p-1"
                                                                    style="width: 90%">Asset Return</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                @elseif ($item->transaction_type == 'Request Return Asset')
                                                    <form action="{{ route('asset-agent.store') }}"
                                                        class="border border-2 rounded-2 p-1" method="post">
                                                        @csrf
                                                        <input type="hidden" name="id" class="dataID"
