@extends('layouts.app', ['page' => 'Assignment', 'pageSlug' => 'Assignment', 'section' => 'Assignment'])
...
@section('content')
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-2 pb-1">
                            <h6 class="text-white text-capitalize ps-3">Ticket Assignment </h6>
                        </div>
                    </div>
                                            ...
                                            <td>
                                                <div class="input-group input-group-dynamic m-0">
                                                    <input type="number" placeholder="SLA Ticket" autocomplete="on"
                                                        name="sla_ticket_time" value="{{ $item->sla_ticket_time }}"
                                                        class="form-control form-control-sm sla_ticket_time" required>
                                                </div>
                                            </td>
                                            <td class="text-center">
    ...
    <form action="{{ route('supervisor.store') }}" style="display: none" method="post" id="FormAction" >
        ...
        <input type="text" name="sla_ticket_time" id="sla_ticket_time">
    </form>
@endsection
    ...
    <script>
        ...
        $(document).ready(function () {
            $('table.tableku').on('click','Button.UpdateButton', function (e) {
                ...
                $('#sla_ticket_time').val(sla_ticket_time.val());
                $('#FormAction').submit();
