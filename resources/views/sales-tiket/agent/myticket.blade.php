                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input type="hidden" name="id" class="dataID"
                                                    value="{{ $item->id }}">
                                                @if (!empty($item->req_status))
                                                @elseif($item->status == 'Awaiting Response')
                                                    <div class="btn-group btn-group-sm" role="group">
                                                        <button type="button"
                                                            class="btn btn-sm btn-success m-0 p-1 Response"
                                                            data-crm="{{ $item->no_CRM }}" data-id="{{ $item->id }}"
                                                            data-bu="{{ $item->bu }}"
                                                            data-company="{{ $item->customer }}"
                                                            data-catagory="{{ $item->sub_katagoriAllTeams->sub_kategori }}"
                                                            data-tgl="{{ date_format(date_create($item->created_at), 'd M Y') }}"
                                                            data-requestor="{{ $item->user->name ?? '' }}"
                                                            data-code="{{ $item->code }}" data-title="Reponse"
                                                            data-status="On Progress" data-comment=""
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-requestor="{{ $item->user->name ?? '' }}"
                                                            data-code="{{ $item->code }}"
                                                            data-title="Req. Extend SLA Response"
                                                            data-status="Unable Respond" data-comment=""
                                                            style="width: 6rem">Extend SLA</button>
                                                        <button type="button"
                                                            class="btn btn-sm btn-warning m-0 p-1 Other"
                                                            data-crm="{{ $item->no_CRM }}" data-id="{{ $item->id }}"
                                                            data-bu="{{ $item->bu }}"
                                                            data-company="{{ $item->customer }}"
                                                            data-catagory="{{ $item->sub_katagoriAllTeams->sub_kategori }}"
                                                            data-tgl="{{ date_format(date_create($item->created_at), 'd M Y') }}"
                                                            data-requestor="{{ $item->user->name ?? '' }}"
                                                            data-code="{{ $item->code }}" data-title="Reassign"
                                                            data-status="Reassign" style="width: 5rem">Reassign</button>
                                                    </div>
                                                @elseif ($item->status == 'On Progress')
                                                    <div class="btn-group btn-group-sm" role="group">
                                                        <button type="button" class="btn btn-sm btn-danger m-0 p-1 Other"
                                                            ...
                                                            data-tgl="{{ date_format(date_create($item->created_at), 'd M Y') }}"
                                                            data-requestor="{{ $item->user->name ?? '' }}"
                                                            data-code="{{ $item->code }}" data-title="Document Revison"
                                                            data-status="Document Revison" style="width: 5rem">Doc.
                                                            Revision</button>
                                                        <button type="button"
                                                            class="btn btn-sm btn-warning m-0 p-1 Other"
                                                            data-crm="{{ $item->no_CRM }}" data-id="{{ $item->id }}"
                                                            ...
                                                            style="width: 5rem">Pending</button>
                                                        <button type="button"
                                                            class="btn btn-sm btn-primary m-0 p-1 ExtendSLA"
                                                            data-crm="{{ $item->no_CRM }}" data-id="{{ $item->id }}"
                                                            data-bu="{{ $item->bu }}"
                                                            ...
                                                            SLA</button>
                                                        <button type="button"
                                                            class="btn btn-sm btn-success m-0 p-1 Resolved"
                                                            data-crm="{{ $item->no_CRM }}" data-id="{{ $item->id }}"
                                                            data-bu="{{ $item->bu }}"
                                                            data-company="{{ $item->customer }}"
                                                            data-catagory="{{ $item->sub_katagoriAllTeams->sub_kategori }}"
                                                            data-tgl="{{ date_format(date_create($item->created_at), 'd M Y') }}"
                                                            data-requestor="{{ $item->user->name ?? '' }}"
                                                            data-code="{{ $item->code }}" data-title="Finish Ticket"
                                                            data-status="Resolved" style="width: 5rem">Finish</button>
                                                ...
                                                @elseif ($item->status == 'Complain')
                                                    <div class="btn-group btn-group-sm" role="group">
                                                        <button type="button"
                                                            ...
                                                            data-tgl="{{ date_format(date_create($item->created_at), 'd M Y') }}"
                                                            data-requestor="{{ $item->user->name ?? '' }}"
                                                            data-code="{{ $item->code }}" data-title="Re Prosess"
                                                            data-status="Re Prosess"
                                                            data-comment="I will continue this ticket now"
                                                            style="width: 7rem">Re Prosess</button>
                                                        <button type="button"
                                                            class="btn btn-sm btn-warning m-0 p-1 Other"
                                                            data-crm="{{ $item->no_CRM }}"
                                                            data-id="{{ $item->id }}"
                                                ...
                                                @elseif ($item->status == 'Document Revison')
                                                    <button type="button" class="btn btn-sm btn-success m-0 p-1 Response"
                                                        ...
                                                        data-requestor="{{ $item->user->name ?? '' }}"
                                                        data-code="{{ $item->code }}" data-title="Re Prosess"
                                                        data-status="End Document Revison"
                                                        data-comment="I will continue this ticket now"
                                                        style="width: 7rem">Re Prosess</button>
                                                @elseif ($item->status == 'Resolved')
                                                    <button type="button" class="btn btn-sm btn-info m-0 p-1 Closed"
                                                        ...
                                                        data-requestor="{{ $item->user->name ?? '' }}"
                                                        data-code="{{ $item->code }}" data-title="Request Closed"
                                                        data-status="Request Close" style="width: 7rem">Request
                                                        Closed</button>
                                                @endif
...
@push('modal')
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="requestor"
                                            id="requestorresponse" readonly>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="input-group input-group-static mb-4">
                                ...
                                <div class="col-6">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="created_at"
                                            id="tglresponse" readonly>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="input-group input-group-static mb-4">
                                        <label class="text-dark">Catagory</label>
                                        <input type="text" class="form-control form-control-sm" name="sub_catagery"
                                            id="catagoryresponse" readonly>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="input-group input-group-static mb-4">
                                        <label class="text-dark">No CRM</label>
                                        <input type="text" class="form-control form-control-sm" name="no_CRM"
                                            id="noCRMresponse" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="customer"
                                            id="companyresponse" readonly>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="input-group input-group-static mb-4">
                                        <label class="text-dark">Base Unit</label>
                                        <input type="text" class="form-control form-control-sm" name="bu"
                                            id="buresponse" readonly>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Response -->
    <div class="modal fade" id="Resolved" tabindex="-1" role="dialog" aria-labelledby="Resolved"
        aria-hidden="true">
        <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
            <div class="modal-content">
                <div class="modal-header py-2 bg-success">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="doc_no" required>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="input-group input-group-static mb-4">
                ...
                <div class="modal-body">
                    <div class="prablem p4" id="problem_ticket">
                        ...
                        <input type="text" class="form-control form-control-sm" name="code" id="coderesponse"  readonly>
                            ...
                            <input type="hidden" class="form-control form-control-sm" name="start_date"
                        ...
                        <form action="{{ route('sa.agent.request') }}" method="post">
                            ...
                            <div class=" input-group input-group-static mb-4">
                                ...
                                <input type="text" class="form-control" value="{{ date('d M Y') }}" readonly
                                    required>
                                <input type="hidden" class="form-control form-control-sm" name="close_request"
