...
@section('content')
    <div class="row align-items-center justify-content-center">
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 pb-5 mb-4">
            <a href="{{ url('sa/agent?status=Awaiting Response') }}">
                <div class="card card-select">
                    <div class="card-header card-footer p-3 pt-2">
                        <div
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 pb-5 mb-4">
            <a href="{{ url('sa/agent?status=On Progress') }}">
                <div class="card card-select">
                    <div class="card-header card-footer p-3 pt-2">
                        <div
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 pb-5 mb-4">
            <a href="{{ url('sa/agent?status=Document Revison') }}">
                <div class="card card-select">
                    <div class="card-header card-footer p-3 pt-2">
                        <div
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 pb-5 mb-4">
            <a href="{{ url('sa/agent?status=Complain') }}">
                <div class="card card-select">
                    <div class="card-header card-footer p-3 pt-2">
                        <div
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 pb-5 mb-4">
            <a href="{{ url('sa/agent?status=Awaiting Update') }}">
                <div class="card card-select">
                    <div class="card-header card-footer p-3 pt-2">
                        <div
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 pb-5 mb-4">
            <a href="{{ url('sa/agent?status=Pending') }}">
                <div class="card card-select">
                    <div class="card-header card-footer p-3 pt-2">
                        <div
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 pb-5 mb-4">
            <a href="{{ url('sa/agent?status=Resolved') }}">
                <div class="card card-select">
                    <div class="card-header card-footer p-3 pt-2">
                        <div
