...
<table style="width:100%;max-width:100%;color:#000000;">
    ...
    <tr>
        <td colspan="3">
            <div style="text-align:left;padding-bottom:10px">
                This is a reminder that an asset return is overdue. Below are the details:
            </div>
        </td>
    </tr>
    ...
    <tr>
        <td>
            <div style="text-align:left;font-weight:bold;">User:</div>
        </td>
        <td>
            <div style="text-align:left;">{{ $assetRequest->user->name }} ({{ $assetRequest->user->email }})</div>
        </td>
    </tr>
    <tr>
        <td>
            <div style="text-align:left;font-weight:bold;">Agent:</div>
        </td>
        <td>
            <div style="text-align:left;">{{ $assetRequest->agent->name }} ({{ $assetRequest->agent->email }})</div>
        </td>
    </tr>
</table>
