@extends('layouts.app', ['page' => 'Agent', 'pageSlug' => 'Category and Location', 'section' => 'Category and Location'])
                                    ...
                                    @foreach ($users as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button type="button"  class="btn btn-sm btn-warning m-0 p-1 UpdateAgent"
