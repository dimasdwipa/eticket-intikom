@extends('layouts.app', ['page' => 'Category and Base Unit', 'pageSlug' => 'Category and Base Unit', 'section' =>
                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="input-group input-group-dynamic m-0">
                                            <input type="text" placeholder="BES" autocomplete="on" name="code"
                                                value="{{ $item->code }}" class="form-control form-control-sm code"
                                                required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group input-group-dynamic m-0">
                                            <input type="text" placeholder="Description" autocomplete="on" name="desc"
                                                value="{{ $item->desc }}" class="form-control form-control-sm desc"
                                                required>
                                        </div>
                                    </td>
                                    <td>
                                        <select class="form-control su_user su_user_id" name="su_user_id">
                                            ...
                                            <option @if ($value->id==$item->su_user_id) selected @endif
                                                value="{{ $value->id }}"> @if($value->permission=="Non Active")
                                                {{ $value->name }} ( leave ) @else {{ $value->name }} @endif</option>
                                            @endforeach
                                        </select>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <input type="hidden" name="id" class="BaseUnitID" value="{{ $item->id }}">
                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="hidden" name="id" class="dataID" value="{{ $item->id }}">
                                        <button type="button" class="btn btn-sm btn-warning m-0 p-1 Update-Category"
                                            style="width: 5rem">Edit</button>
                                    </td>
                                </tr>
                                @endforeach
                                    ...
                                    <td>
                                        <div class="input-group input-group-dynamic m-0">
                                            <input type="text" placeholder="Sub Category Name" autocomplete="on"
                                                name="sub_kategori" value="{{ $item->sub_kategori }}"
                                    ...
                                    <!-- <td>
                                                <div class="input-group input-group-static m-0">
                                                    <select class="form-control supervisor supervisor_id" name="supervisor_id">
                                                        <option></option>
                                                        @foreach ($supervisors as $value)
                                                            <option @if ($value->id==$item->supervisor_id) selected @endif value="{{ $value->id }}"> @if($value->permission=="Non Active") {{ $value->name }} ( leave ) @else {{ $value->name }} @endif</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </td>
                                            <td>
                                                <select class="form-control agent agent_id" name="agent_id" >
                                                    <option></option>
                                                    @foreach ($agents as $value)
                                                        <option @if ($value->id==$item->agent_id) selected @endif value="{{ $value->id }}"> @if($value->permission=="Non Active") {{ $value->name }} ( leave ) @else {{ $value->name }} @endif</option>
                                                    @endforeach
                                                </select>
                                            </td> -->
                                    <td class="text-center">
                                        <input type="hidden" name="id" class="dataID" value="{{ $item->id }}">
                                        <button type="button" class="btn btn-sm btn-warning m-0 p-1 Update-SubCategory"
                                            style="width: 5rem">Edit</button>
                                    </td>
                                </tr>
                                @endforeach
...
<form action="{{ route('sub-category.update',0) }}" style="display: none" method="post" id="FormActionSubCategory">
    @method('PATCH')
    @csrf
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="input-group input-group-dynamic mb-4">
                                <input type="text" placeholder="Sub Category Name" autocomplete="on" name="sub_kategori"
                                    class="form-control form-control-sm" required>
                            </div>
                        </div>
                        <div class="col-6">
                        ...
                        <!-- <div class="col-6">
                                <div class="input-group input-group-static mb-3">
                                    <select class="form-control agent agent_id" name="agent_id">
                                        <option></option>
                                        @foreach ($agents as $value)
                                            <option value="{{ $value->id }}"> @if($value->permission=="Non Active") {{ $value->name }} ( leave ) @else {{ $value->name }} @endif</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
