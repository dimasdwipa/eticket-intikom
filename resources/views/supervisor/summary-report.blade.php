                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control select2 lokasi_id" name="lokasi_id" required>
                                            <option></option>
                                            @foreach ($lokasi as $value)
                                            <option @if ($value->id==$item->lokasi_id) selected @endif value="{{
                                                $value->id }}">{{ $value->lokasi }}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                    <td>{{ $item->bu }}</td>
                                    <td>
                                        {{ $item->katagori->kategori }}
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="input-group input-group-dynamic m-0">
                                            <input type="text" placeholder="SLA Repair" autocomplete="on"
                                                name="sla_repair" value="{{ $item->sla_repair }}"
                                                class="form-control form-control-sm datepicker sla_repair" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group input-group-dynamic m-0">
                                            <input type="text" placeholder="SLA Repair" autocomplete="on"
                                                name="sla_repair_end" value="{{ $item->sla_repair_end }}"
                                                class="form-control form-control-sm datepicker sla_repair_end" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group input-group-dynamic m-0">
                                    ...
                                    <td>
                                        ...
                                        <select class="form-control select2 status_id" name="status" required>
                                            <option @if('Open'==$item->status) selected @endif value="Open"
                                                disabled>Open</option>
                                            <option @if ('Awaiting Response'==$item->status) selected @endif
                                                value="Awaiting Response" disabled>Awaiting Response</option>
                                            <option @if ('On Progress'==$item->status) selected @endif value="On
                                                Progress" >On Progress</option>
                                            <option @if ('Repairing'==$item->status) selected @endif
                                                value="Repairing">Repairing</option>
                                            <option @if ('Pending'==$item->status) selected @endif
                                                value="Pending">Pending</option>
                                            <option @if ('Resolved'==$item->status) selected @endif value="Resolved">Resolved</option>
