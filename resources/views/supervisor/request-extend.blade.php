                        ...
                        <table
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder  ps-3"
                                    style="min-width: 10rem">
                                        Extend SLA Respon Reuqest
                                    </th>
                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder  ps-3"
                                        style="min-width: 10rem">
                                        Extend SLA Ticket Reuqest
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                ...
                                                style="width: 5rem" href="{{url('storage/files/tickets/'.$item->ticket->files)}}" target="_blank" >
                                                Show
                                                </a>
                                                <a class="btn btn-sm btn-outline-success m-0 p-1"
                                                style="width: 5rem" href="{{url('storage/files/tickets/'.$item->ticket->files)}}" target="_blank"  download>
                                                Donwload
                                                </a>
                                            </div>
                                    </td>
                                    ...
                                    <td class="text-center">
                                            <button type="button" class="btn btn-sm btn-outline-info m-0 p-1"
                                                style="width: 5rem" data-bs-toggle="modal" data-bs-target="#Detail"
                                                data-problem=" {{ $item->comment }}">Detail</button>
                                    </td>
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm btn-outline-info m-0 p-1"
                                                style="width: 5rem" data-bs-toggle="modal" data-bs-target="#Detail"
                        ...
                        <div class="col-6">
                            <div class="input-group input-group-static my-3">
                                <select class="form-control form-control-sm select2" name="filter_by">
                                    ...
                                    <option value="users.name" @if (isset($_GET['filter_by']) ? ($_GET['filter_by']=='users.name' ?
