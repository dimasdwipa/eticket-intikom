                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                            ...
                                            <div class="btn-group btn-group-sm" role="group">
                                                <button type="button" class="btn btn-sm btn-success m-0 p-1 Response" data-id="{{ $item->id }}" data-code="{{ $item->code }}" data-title="Reponse" data-status="On Progress" data-comment="I will do this task now" style="width: 6rem">Reponse</button>
                                                <button type="button" class="btn btn-sm btn-primary m-0 p-1 ExtendSLA" data-id="{{ $item->id }}" data-code="{{ $item->code }}" data-title="Unable To Respond" data-status="Unable Respond" data-comment="" style="width: 6rem">Unable Respond</button>
                                            </div>
                                            @elseif ($item->status=="On Progress")
                                            <div class="btn-group btn-group-sm" role="group">
                                                <button type="button" class="btn btn-sm btn-warning m-0 p-1 Other" data-id="{{ $item->id }}" data-code="{{ $item->code }}" data-title="Request Repair" data-status="Request Repair" style="width: 5rem">Request Repair</button>
                                                <button type="button" class="btn btn-sm btn-danger m-0 p-1 Other" data-id="{{ $item->id }}" data-code="{{ $item->code }}" data-title="Request Pending" data-status="Request Pending" style="width: 5rem">Request Pending</button>
                                                <button type="button" class="btn btn-sm btn-primary m-0 p-1 ExtendSLA" data-id="{{ $item->id }}" data-code="{{ $item->code }}" data-title="Extend SLA" data-status="Extend SLA" style="width: 5rem">Extend SLA</button>
                                                <button type="button" class="btn btn-sm btn-success m-0 p-1 Response" data-id="{{ $item->id }}" data-code="{{ $item->code }}" data-title="Resolved Ticket" data-status="Resolved" style="width: 5rem">Resolved</button>
                                                <button type="button" class="btn btn-sm btn-info m-0 p-1 Closed" data-id="{{ $item->id }}" data-code="{{ $item->code }}" data-title="Request Closed" data-status="Request Close" style="width: 5rem">Request Closed</button>
                                            </div>
                                            @elseif ($item->status=="Repairing")
                                                <button type="button" class="btn btn-sm btn-success m-0 p-1 Response" data-id="{{ $item->id }}" data-code="{{ $item->code }}" data-title="End Repair" data-status="End Repair" data-comment="I will continue this ticket now" style="width: 7rem">End Repair</button>
                                            @elseif ($item->status=="Pending")
                                                <button type="button" class="btn btn-sm btn-success m-0 p-1 Response" data-id="{{ $item->id }}" data-code="{{ $item->code }}" data-title="End Pending" data-status="End Pending" data-comment="I will continue this ticket now" style="width: 7rem">End Pending</button>
                                            @elseif ($item->status=="Resolved")
                                                <button type="button" class="btn btn-sm btn-info m-0 p-1 Closed" data-id="{{ $item->id }}" data-code="{{ $item->code }}" data-title="Request Closed" data-status="Request Close" style="width: 7rem">Request Closed</button>
                                            @endif
                                    </td>
                                </tr>
                                @endforeach
            ...
            <div class="modal-body">
                ...
                <div class="prablem p4" id="problem_ticket">
                    ...
                    <div class="input-group input-group-static mb-4">
                        ...
                        <textarea class="form-control form-control-sm" placeholder="note"
                        style="border-radius:0.25rem !important" rows="3" name="note"></textarea>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="prablem p4" id="problem_ticket">
                    ...
                    <input type="text" class="form-control form-control-sm" name="start_date" id="start_date_other" value="{{ date('Y-m-d H:i:s') }}"  readonly>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="prablem p4" id="problem_ticket">
                    ...
                    <input type="text" class="form-control form-control-sm" name="close_request" id="close_request" value="{{ date('Y-m-d H:i:s') }}"  readonly>
                    </div>
                    <input type="hidden" name="id" id="idresponse">
                    <input type="hidden" name="status" id="status">
