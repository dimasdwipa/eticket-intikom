@extends('layouts.app', ['page' => 'My Request To SPV', 'pageSlug' => 'My Request To SPV', 'section' => 'My Request To SPV'])
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-2 pb-1">
                            <h6 class="text-white text-capitalize ps-3">My Request To SPV</h6>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($tickets as $item)
                                        <tr>
                                            ...
                                            <td>
                                                {{ $item->ticket->lokasi->lokasi ?? '' }}
                                            </td>
                                            <td>{{ $item->ticket->bu }}</td>
                                            <td>
                                                {{ $item->ticket->katagori->kategori ?? '' }}
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn btn-sm btn-outline-info m-0 p-1"
                                                    ...
                                                    data-problem="{{ $item->ticket->problem }}">Detail</button>
                                            </td>
                                            <td>
                                                {{ $item->ticket->agent->name ?? '' }}
                                            </td>
                                            <td style="text-align: center">
                                                {{ $item->ticket->sla_ticket_time }}
                                            </td>
                                            <td>
                                                {{ $item->ticket->sla_assignment }}
                                            </td>
                                            <td>
                                                {{ $item->ticket->sla_respone }}
                                            </td>
                                            <td>
                                                {{ $item->ticket->sla_repair }}
                                            </td>
                                            <td>
                                                {{ $item->ticket->sla_repair_end }}
                                            </td>
                                            <td>
                                                {{ $item->ticket->sla_pending }}
                                            </td>
                                            <td>
                                                {{ $item->ticket->sla_pending_end }}
                                            </td>
                                            <td>
                                                {{ $item->ticket->sla_resolved }}
                                            </td>
                                            <td>
                                                {{ $item->ticket->sla_close }}
                                            </td>
                                            <td>
                                                {{ $item->ticket->status }}
                                            </td>
