...
<head>
    ...
    <style type="text/css">
        ...
        .ReadMsgBody {width:100%; background: #ffffff;}
        /* iOS BLUE LINKS */
    ...
    <tr><!-- Outer Table -->
        <td align="center"  bgcolor="#f0f0f0" data-composer>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;" >
                <!-- lotus-header-2 -->
                <tr>
                    <td align="center"  class="container-padding" style="background:#ffffff">

                        <!-- Content -->
                        <table border="0" style="padding-left: 10%;padding-right: 10%" cellpadding="0" cellspacing="0" role="presentation" class="row" width="100%" style="100%">
                            <tr>
                                <td height="10" style="font-size:40px;line-height:40px;" >&nbsp;</td>
                            </tr>
                            <tr  >
                                <td class="center-text"   style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                     @yield('content')
                                </td>
                            </tr>

                            <tr>
                                <td height="60" style="font-size:40px;line-height:40px;" >&nbsp;</td>
                            </tr>
                        </table>
                        <!-- Content -->
            ...
            {{-- <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;" >
                ...
                <tr>
                    <td align="center"  bgcolor="#f0f0f0" class="container-padding">
                        ...
                        <!-- Content -->
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;font-weight: bold">
                            <tr>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <a href="ext:3434"    style="color:#6e6e6e;"><span>Tel : 3434</span></a>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <a href="mailto:{{ env('MAIL_FROM_ADDRESS') }}"    style="color:#6e6e6e;"><span>{{ env('MAIL_FROM_ADDRESS') }}</span></a> - <a href="{{ url('/') }}"    style="color:#6e6e6e;"><span>{{ config('app.name') }}</span></a>

                                </td>
                            </tr>
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    Jl. Kuningan Barat 2 No. 11 Jakarta 12710, Indonesia
                                </td>
                            </tr>
                            <tr>
                                <td height="50" style="font-size:50px;line-height:50px;" >&nbsp;</td>
