...
<table style="width:100%;max-width:100%;color:#000000;">
    ...
    <tr>
        <td>
            <div style="text-align:left;padding-bottom:10px">The following are overdue tickets :</div>
        </td>
    </tr>
</table>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" style="width:100%;max-width:100%;color:#000000;">
    <tr>
        ...
        <td cellpadding="0" cellspacing="0" style="border:solid 1px #000000;padding: 5px;color:#010f22;background: #D8D8D8;text-align: center;font-weight: bold">Requestor</td>
        <td cellpadding="0" cellspacing="0" style="border:solid 1px #000000;padding: 5px;color:#010f22;background: #D8D8D8;text-align: center;font-weight: bold">@if($user->role=="supervisor") Agent @else Supervisor @endif</td>
    ...
    <tr>
        ...
        <td cellpadding="0" cellspacing="0" style="border:solid 1px #000000;padding: 4px 10px;color:#000000; text-align: center">{{$item->user->name}}</td>
        <td cellpadding="0" cellspacing="0" style="border:solid 1px #000000;padding: 4px 10px;color:#000000; text-align: center">@if($user->role=="supervisor") {{$item->agent->name}} @else {{$item->supervisor->name}} @endif</td>
    ...
    <tr>
        <td>
            <div style="text-align:left;padding-top:20px">
                Please immediately follow up this ticket.
            </div>
        </td>
    </tr>
    <tr>
