...
<table style="width:100%;max-width:100%;color:#000000;">
    ...
    <tr>
        <td colspan="3">
            <div style="text-align:left;padding-bottom:10px">Your ticket No. :  {{$data->ticket->code}}, Date : {{$data->ticket->tanggal}} cannot be processed, because:</div>
        </td>
    </tr>
    ...
    <tr>
        <td colspan="3">
            <div style="text-align:left;padding-bottom:10px">The creation of SO {{$data->ticket->sub_katagori->sub_kategori}} will be done after the data / problem above has been resolved.</div>
        </td>
    </tr>
    <tr>
        <td colspan="3">
