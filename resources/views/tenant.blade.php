...
<head>
  ...
  <title>Select Tenant - {{ config('app.name', 'Laravel') }}</title>
  <!--     Fonts and icons     -->
...
<body class="antialiased" style="background-image: url('http://localhost:8000/assets/photo.png');">
    <div class="feat bg-gray pt-5 pb-5">
        <div class="container">
            <div class="row justify-content-md-center">
                <div class="section-head col-sm-12" >
                    <h4><span>Choose your</span> Menu Ticket</h4>
                </div>
                <?php $sales=false;$normal=false; ?>
