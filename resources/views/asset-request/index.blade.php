@extends('layouts.app', ['page' => 'My item loan', 'pageSlug' => 'My item loan', 'section' => 'My item loan'])
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-2 pb-1">
                            <h6 class="text-white text-capitalize ps-3">My item loan</h6>
                        </div>
                    </div>
                            ...
                            <table
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xs font-weight-bolder ps-3">Tenant
                                        </th>
                                    ...
                                    @foreach ($asset_request as $item)
                                        <tr>
                                            <td class="text-center">
                                                @if ($item->transaction_type == 'Has been given')
                                                    <form action="{{ route('asset-request.update', $item->id) }}"
                                                        class="border border-2 rounded-2 p-2" method="post">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <input class="form-control form-control-sm border"
                                                                    type="date" name="est_return_date" value="{{ $item->est_return_date }}">
                                                            </div>
                                                            <div class="col-12 pt-2">
                                                                <button type="submit"
                                                                    class="btn btn-sm btn-warning m-0 p-1 "
                                                                    style="width: 100%">Extend Return Asset</button>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col p-0">
                                                                <button type="submit" class="btn btn-sm btn-success"
                                                                    style="width: 50%">Return Asset</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                @endif
