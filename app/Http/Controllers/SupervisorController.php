...
class SupervisorController extends Controller
{
    ...
    public function report()
    {
        ...
        return view('supervisor.summary-report')
            ->with('lokasi', Lokasi::orderby('created_at','desc')->get())
            ->with('kategori', Kategori::orderby('created_at','desc')->get())
            ->with('subkategori', SubKategori::orderby('created_at','desc')->get())
            ->with('agents', $agents)
    ...
    public function updatereport(Request $request)
    {
        ...
        try {
            ...
            $data->katagori_id = $SubKategori->katagori_id;
            $data->agent_id = $request->agent_id;
    ...
    public function request_extend()
    {
        ...
        return view('supervisor.request-extend')
            ->with('agents', $agents)
            ->with('tickets', $tickets);
    }
    ...
    public function complain()
    {
        ...
        return view('supervisor.complain')
            ->with('agents', $agents)
            ->with('tickets', $tickets);
    }
    ...
    public function sla_report()
    {
        ...
        return view('supervisor.sla-summary-report')
            ->with('lokasi', Lokasi::orderby('created_at','desc')->get())
            ->with('kategori', Kategori::orderby('created_at','desc')->get())
            ->with('subkategori', SubKategori::orderby('created_at','desc')->get())
            ->with('agents', $agents)
    ...
    public function sla_report_sa()
    {
        ...
        return view('supervisor.sla-summary-report-sa')
            ->with('lokasi', Lokasi::orderby('created_at','desc')->get())
            ->with('kategori', Kategori::orderby('created_at','desc')->get())
            ->with('subkategori', SubKategori::orderby('created_at','desc')->get())
            ->with('agents', $agents)
